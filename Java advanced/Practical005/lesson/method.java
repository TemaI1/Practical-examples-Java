// запись и чтениу данных в/из файла:

/**
     * 2. Предположить, что числа в исходном массиве из 9 элементов имеют диапазон
     * [0, 3], и представляют собой, например, состояния ячеек поля для игры в крестики-нолики,
    ...
    static void saveData() throws IOException {
        ...
        FileOutputStream fos = new FileOutputStream("homework_save1.out");
    ...
    static void readData() throws IOException {
        int[] ar20 = new int[9];
         FileInputStream fis = new FileInputStream("homework_save1.out");
         int b;
         int i = 0;
         while ((b = fis.read()) != -1) {
